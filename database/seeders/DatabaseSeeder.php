...
class DatabaseSeeder extends Seeder
{
    ...
    private function createAppraisal(array $data): Appraisal
    {
        ...
        $appraisal = Appraisal::create([
            ...
            'buHeadReview' => ($status === 'COMPLETED') ? json_encode([
                'comments' => $data['buHeadComment'] ?? "{$employeeName} is approved for the final cycle outcome.",
    ...
    public function run(): void
    {
        ...
        // Users
        $employees = [
            $buHead, $hr, $techManager, $mediaManager, $marketingManager,
        ...
        $this->createAppraisal([
            ...
            'buHeadComment' => "Approved for strong performance and sustained product impact.",
        ...
        $this->createAppraisal([
            ...
            'buHeadComment' => "Completed with a positive final assessment.",
        ...
        $this->createAppraisal([
            ...
            'buHeadComment' => "Approved with a solid final rating and measured hike.",
        ...
        $this->createAppraisal([
            ...
            'buHeadComment' => "Approved with a strong performance outcome.",
        ...
        $this->createAppraisal([
            ...
            'buHeadComment' => "Approved with a balanced salary outcome.",
        ...
        $this->createAppraisal([
            ...
            'buHeadComment' => "Approved with a positive final outcome.",
